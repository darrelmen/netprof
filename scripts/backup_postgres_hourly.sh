...
date
curl -ugvidaver:AP7UBZfNhCphhouwNrWyL2WqWX -T ./ltea_data2_dump.tar.gz "https://kws-bugs.ll.mit.edu/artifactory/dli-archiving/ltea-data2-pg/hourly/ltea_data2_dump.tar.gz"
date
echo "Done!"