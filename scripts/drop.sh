...
#java $certs -cp "/opt/netprof/installation/current/lib/*" mitll.langtest.server.database.copy.CopyToPostgres -d $1 > drop.log
java -cp "/opt/netprof/installation/current/lib/*" mitll.langtest.server.database.copy.CopyToPostgres -d $1 > drop.log