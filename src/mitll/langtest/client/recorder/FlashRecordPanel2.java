 ...
 *
 */
public class FlashRecordPanel2 extends FlowPanel {
   ...
   */
	public FlashRecordPanel2(String id){
/*    save_button = new InlineHTML();
  ...
  public native void showPermission() /*-{
    ...
    $wnd.gotSaveComplete = $entry(@mitll.langtest.client.recorder.FlashRecordPanel2::saveComplete());
    $wnd.swfCallback = $entry(@mitll.langtest.client.recorder.FlashRecordPanel2::swfCallback());
