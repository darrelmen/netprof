 ...
 */
public class MultiGroupSectionWidget extends FluidContainer implements SectionWidget {
  private static final String ANY = SectionExerciseList.ANY;
  private List<Button> buttons = new ArrayList<Button>();
  private ItemClickListener listener;
  private String type;

  public MultiGroupSectionWidget(String type, ItemClickListener listener) {
    this.type = type;
