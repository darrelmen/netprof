...
public class ASRScorePanel extends FlowPanel implements ScoreListener {
  ...
  /**
   * @see mitll.langtest.client.goodwave.GoodwaveExercisePanel#GoodwaveExercisePanel(mitll.langtest.shared.Exercise, mitll.langtest.client.LangTestDatabaseAsync, mitll.langtest.client.user.UserFeedback, mitll.langtest.client.exercise.ExerciseController)
   */
  ...
  /**
  *
   * @see AudioPanel#useResult(mitll.langtest.shared.scoring.PretestScore, mitll.langtest.client.goodwave.AudioPanel.ImageAndCheck, mitll.langtest.client.goodwave.AudioPanel.ImageAndCheck, mitll.langtest.client.goodwave.AudioPanel.ImageAndCheck, boolean)
   * @param score
   */
