...
public class FontChecker {
  ...
  public FontChecker(UserFeedback feedback) {
...
//      "Nafees Pakistani Naskh" // testing
      ...
      feedback.showErrorMessage("Pashto Kror Asiatype not installed",
        "Pashto Kror Asiatype not installed.<p/>" +
   ...
   *        d.detect('font name');
   */
  private native boolean checkFont(String fontToCheck) /*-{
